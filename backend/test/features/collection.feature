Feature: Receiving collections
  ...
  Scenario: Send a request to the outbox URI of peter-lustig and expect a ordered collection
    ...
    """
    {
      ...
      "id": "http://localhost:4123/api/users/renate-oberdorfer/outbox",
      "summary": "renate-oberdorfers outbox collection",
      "type": "OrderedCollection",
      "first": "http://localhost:4123/api/users/renate-oberdorfer/outbox?page=true",
      "totalItems": 0
    }
    """
  ...
  Scenario: Send a request to the following URI of peter-lustig and expect a ordered collection
    ...
    {
      "@context": "https://www.w3.org/ns/activitystreams",
      "id": "http://localhost:4123/api/users/renate-oberdorfer/following",
      "summary": "renate-oberdorfers following collection",
      "type": "OrderedCollection",
      "first": "http://localhost:4123/api/users/renate-oberdorfer/following?page=true",
      "totalItems": 0
    }
    """
  ...
  Scenario: Send a request to the followers URI of peter-lustig and expect a ordered collection
    ...
    {
      "@context": "https://www.w3.org/ns/activitystreams",
      "id": "http://localhost:4123/api/users/renate-oberdorfer/followers",
      "summary": "renate-oberdorfers followers collection",
      "type": "OrderedCollection",
      "first": "http://localhost:4123/api/users/renate-oberdorfer/followers?page=true",
      "totalItems": 0
    }
    """
  ...
  Scenario: Send a request to the outbox URI of peter-lustig and expect a paginated outbox collection
    ...
    {
      "@context": "https://www.w3.org/ns/activitystreams",
      "id": "http://localhost:4123/api/users/renate-oberdorfer/outbox?page=true",
      "summary": "renate-oberdorfers outbox collection",
      "type": "OrderedCollectionPage",
      "totalItems": 0,
      "partOf": "http://localhost:4123/api/users/renate-oberdorfer/outbox",
      "orderedItems": []
    }
    """
  ...
  Scenario: Send a request to the following URI of peter-lustig and expect a paginated following collection
    ...
    {
      "@context": "https://www.w3.org/ns/activitystreams",
      "id": "http://localhost:4123/api/users/renate-oberdorfer/following?page=true",
      "summary": "renate-oberdorfers following collection",
      "type": "OrderedCollectionPage",
      "totalItems": 0,
      "partOf": "http://localhost:4123/api/users/renate-oberdorfer/following",
      "orderedItems": []
    }
    """
  ...
  Scenario: Send a request to the followers URI of peter-lustig and expect a paginated followers collection
    ...
    {
      "@context": "https://www.w3.org/ns/activitystreams",
      "id": "http://localhost:4123/api/users/renate-oberdorfer/followers?page=true",
      "summary": "renate-oberdorfers followers collection",
      "type": "OrderedCollectionPage",
      "totalItems": 0,
      "partOf": "http://localhost:4123/api/users/renate-oberdorfer/followers",
      "orderedItems": []
    }
    """
