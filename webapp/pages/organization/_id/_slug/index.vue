...
<script>
 ...
 import OrganizationMutations from '~/graphql/OrganizationMutations'
 ...
 export default {
   ...
   computed: {
     ...
     heroImageStyle() {
        ...
        */
       if (!this.organization.image || typeof this.organization.image.aspectRatio !== 'number') return false
