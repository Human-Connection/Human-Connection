<template>
  <dropdown
class="content-menu" :placement="placement"
offset="5"
>
    <template
...
>
      <slot
name="button" :toggleMenu="toggleMenu"
>
        <ds-button
class="content-menu-trigger" size="small"
ghost @click.prevent="toggleMenu"
>
    ...
    <div
slot="popover" slot-scope="{ toggleMenu }"
