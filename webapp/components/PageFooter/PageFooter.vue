<template>
  <div id="footer" class="ds-footer">
    ...
    <span>-</span>
    <a href="https://human-connection.org/impressum/" target="_blank" v-html="$t('site.imprint')"></a>
    <span>-</span>
    <nuxt-link to="/terms-and-conditions">{{ $t('site.termsAndConditions') }}</nuxt-link>
    <span>-</span>
    <nuxt-link to="/code-of-conduct">{{ $t('site.code-of-conduct') }}</nuxt-link>
    <span>-</span>
    <a href="https://human-connection.org/datenschutz/" target="_blank" v-html="$t('site.data-privacy')"></a>
    <span>-</span>
